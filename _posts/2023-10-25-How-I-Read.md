...
<i>**Preface**. This is a self reflection on Reading written as a story with my reading techniques contextually spread through it.
There is a separate section at the bottom which contains only the technique. Either way I recommend bookmarking and reading a few times with good focus.</i>
...
## My reading technique (aka. x-ray)
